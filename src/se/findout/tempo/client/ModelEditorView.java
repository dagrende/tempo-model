...
public class ModelEditorView extends FlowPanel implements ToolSelectionListener {
	...
	public class CreateRectangleChange implements Change {
		...
		public void execute() {
			System.out
					.println("ModelEditorView.CreateRectangleChange.execute()");
		...
		@Override
		public void undo() {
			System.out.println("ModelEditorView.CreateRectangleChange.undo()");
	...
	public class DeleteCommand implements Change {
		...
		@Override
		public void execute() {
			System.out.println("ModelEditorView.DeleteCommand.execute()");
		...
		@Override
		public void undo() {
			System.out.println("ModelEditorView.DeleteCommand.undo()");
			if (deletedItem != null) {
